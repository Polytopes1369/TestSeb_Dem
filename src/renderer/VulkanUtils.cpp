...
#include <stdexcept>
#include "renderer/VulkanPipeline.h" // For VK_CHECK macro, assuming it is defined in VulkanPipeline.h or similar. Let's make sure it compiles or use basic check.
