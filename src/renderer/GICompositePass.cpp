...
namespace renderer {
    ...
    namespace {
        ...
        std::vector<char> ReadShaderFile(const std::string& filename) {
            ...
            if (!file.is_open()) {
                throw std::runtime_error("GICompositePass: failed to open SPIR-V file: " + filename);
            }
    ...
    void GICompositePass::Init(VkDevice device, VmaAllocator allocator, VkCommandPool commandPool, VkQueue queue,
        ...
        VkShaderModule shaderModule = CreateShaderModule(m_Device, ReadShaderFile("shaders/GIComposite.comp.spv"));
