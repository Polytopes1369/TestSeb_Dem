...
namespace renderer {
    ...
    public:
        ...
        static constexpr uint32_t kProbeTileSize = 8;   // Screen pixels per probe tile, both axes.
        static constexpr uint32_t kProbeRayCount = 64;  // Fibonacci-sphere rays traced per probe per frame.
        static constexpr uint32_t kGridWorkgroupSize = 8; // RecordTemporal's/RecordGather's local_size_x/y.
        static constexpr float kTemporalAlpha = 0.05f;  // Exponential moving-average blend factor.
